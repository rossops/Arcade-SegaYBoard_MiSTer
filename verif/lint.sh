...
verilator --lint-only $W -Wno-TIMESCALEMOD -Irtl/video -Irtl/cpu/fx68k verif/fx68k.vlt rtl/yb_pkg.sv rtl/video/yb_video_timing.sv rtl/mem/yb_dpram.sv \
  ...
  rtl/video/yb_palette_5242.sv rtl/mem/yb_fb_if.sv rtl/video/yb_ysprite_5305.sv rtl/video/yb_rotate_5306.sv rtl/video/yb_bsprite_5196.sv rtl/yb_core.sv --top-module yb_core >/dev/null
echo "lint clean"
