...
OWN="rtl/video/yb_video_timing.sv rtl/mem/sdram.sv rtl/mem/yb_rom_loader.sv rtl/mem/yb_dpram.sv \
  rtl/cpu/yb_math_5248.sv rtl/cpu/yb_math_5249.sv rtl/io/yb_ana_shape.sv \
...
verilator --lint-only $W -Irtl/video rtl/yb_pkg.sv rtl/video/yb_video_timing.sv rtl/yb_core.sv --top-module yb_core >/dev/null
echo "lint clean"
